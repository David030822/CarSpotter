...
from api.services.service import insert_cars_and_dealer_by_dealer_name, get_cars_and_dealer_by_dealer_name, get_cars_by_dealer_id
...
@dealer_router.get("/dealer_id/{dealer_id}/cars")
